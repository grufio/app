...
-- =============================================================================
-- Re-appended storage section after `supabase migration squash --linked`.
--
-- Mandatory per docs/playbooks/squash-migrations.md: the squash dump covers
-- only the `public` schema. Anything in `storage` (RLS policies on
-- storage.objects, bucket rows) was lost and is restored below.
-- =============================================================================

-- pigment_swatches bucket (created by the original
-- 20260519130500_pigment_swatches_bucket.sql migration; replayed here so
-- a fresh `supabase db reset --local` brings the bucket back).
