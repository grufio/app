...
begin
  -- Idempotency guard:
  -- `dpi_x/dpi_y` are dropped later by db/023. If this bootstrap is re-run against an already-migrated DB,
...
begin
  -- This bootstrap file may be re-run against a DB where legacy columns were already dropped.
