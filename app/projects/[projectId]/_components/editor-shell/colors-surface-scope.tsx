 ...
 * the surface and the floating bottom nav stays visible above it so the
 * user can switch to Image / Filter / Trace at any time. There's no Edit
 * affordance because Colors has nothing to edit.
 */
