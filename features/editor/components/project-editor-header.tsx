 ...
 *   entirely — Home navigation lives in the mobile bottom-nav.
 * - Back link to the dashboard + editable project title.
 *
 * The editor itself is canvas-first on both viewports (floating
 * section bar + sheets); there are no side panels to toggle, so this
 * header carries no panel controls anymore.
 */
