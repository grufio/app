...
export function MobileTopRightBar({ onEditTap, ariaLabelEdit = "Edit", viewOptions }: Props) {
  ...
  return (
    <div
      ...
      className="absolute top-3 right-3 z-20 inline-flex items-center gap-1 rounded-lg bg-zinc-900/95 px-1 py-1 shadow-lg ring-1 ring-white/10 backdrop-blur md:hidden"
    >
      {viewOptions ? (
