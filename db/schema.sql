...
CREATE TABLE IF NOT EXISTS "public"."project_image_trace" (
    ...
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "base_image_id" "uuid",
    "display_x_px_u" "text" DEFAULT '0'::"text" NOT NULL,
...
CREATE TABLE IF NOT EXISTS "public"."project_images" (
    ...
    "initial_display_width_px_u" "text" DEFAULT '0'::"text" NOT NULL,
    "initial_display_height_px_u" "text" DEFAULT '0'::"text" NOT NULL,
...
CREATE TABLE IF NOT EXISTS "public"."project_workspace" (
    ...
    "padding_top_px_u" "text" DEFAULT '0'::"text" NOT NULL,
    "padding_bottom_px_u" "text" DEFAULT '0'::"text" NOT NULL,
    "padding_left_px_u" "text" DEFAULT '0'::"text" NOT NULL,
    "padding_right_px_u" "text" DEFAULT '0'::"text" NOT NULL,
    ...
    CONSTRAINT "project_workspace_padding_bottom_px_u_range" CHECK (((("padding_bottom_px_u")::bigint >= 0) AND (("padding_bottom_px_u")::bigint <= '32768000000'::bigint))),
    CONSTRAINT "project_workspace_padding_left_px_u_range" CHECK (((("padding_left_px_u")::bigint >= 0) AND (("padding_left_px_u")::bigint <= '32768000000'::bigint))),
    CONSTRAINT "project_workspace_padding_right_px_u_range" CHECK (((("padding_right_px_u")::bigint >= 0) AND (("padding_right_px_u")::bigint <= '32768000000'::bigint))),
    CONSTRAINT "project_workspace_padding_top_px_u_range" CHECK (((("padding_top_px_u")::bigint >= 0) AND (("padding_top_px_u")::bigint <= '32768000000'::bigint))),
