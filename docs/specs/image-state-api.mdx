...
- Rounding happens **exactly once** (bake-in / user input conversion). Save/persist must not apply a second rounding pass.
...
- Bounds: sizes are clamped/validated to \(1px..32768px\) (in µpx: `1_000_000..32_768_000_000`).
